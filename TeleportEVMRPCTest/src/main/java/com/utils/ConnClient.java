...
public class ConnClient {
    ...
    public Web3j getAnchorNodeConn() {
        return anchorNodeConn;
    }

    public void setAnchorNodeConn(Web3j anchorNodeConn) {
        this.anchorNodeConn = anchorNodeConn;
    }
}
