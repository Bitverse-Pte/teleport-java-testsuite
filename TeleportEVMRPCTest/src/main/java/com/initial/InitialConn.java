...
public class InitialConn {
    ...
    public void init() throws Exception {
        ...
        initWebSS(bitostSuiteSetting.getWebsocket_url());
    }

    private void initWebSS(String url) throws ConnectException {
        WebSocketPool.getInstance().initialWSS(url);
    }
    ...
    private void initNodeConn(){
        ...
        Web3jConnPool.getInstance()
            .getConnClient()
            .setAnchorNodeConn(Web3jConnPool.
                    getInstance().getConnClient().getWeb3jList().get(0));
    }
